  ...
  return (
    <div className="w-full lg:h-[93.6vh] flex flex-col 2xl:px-64 xl:px-20  py-10 transition-all duration-300">
      <div className="flex flex-row gap-4 items-center">
        <Button
          onClick={() => navigate("/@peluqueriastylospalmira/services")}
          isIconOnly
          variant="bordered"
      ...
      <div className="grid lg:grid-cols-[0.4fr_1.6fr] grid-cols-1 h-full mt-8">
        ...
        <article
          className="ml-8 flex flex-col gap-4 overflow-y-scroll pr-4
        ...
        >
          <h2 className="text-3xl font-bold lg:fixed z-10 bg-white w-full">
            Historial
          </h2>
            ...
            {clientHistory.length > 0 ? (
              clientHistory?.map((service) => (
                <ClientService
                  ...
                  reviews={reviews}
                  loadClientReviews={loadClientReviews}
                />
              ))
            ) : (
