  ...
  return (
    <div className="flex flex-col gap-2 min-w-[350px]">
      <React.Fragment key={hora}>
        ...
        <div className="flex flex-col gap-4 max-h-[55vh] pr-2 overflow-y-auto scrollbar scrollbar-thumb-slate-200 scrollbar-thumb-rounded-full scrollbar-track-rounded-full active:scrollbar-thumb-primary hover:scrollbar-thumb-slate-300">
          {citas.map((cita) => (
            <Appointment
              key={cita.id}
