...
import hola from "../../assets/hola.png"; // Asegúrate de que la ruta sea correcta
import { Tooltip } from "@nextui-org/react";
import dayjs from "dayjs"; // Importar dayjs para formatear la fecha
...
function AppointmentCard({ clientName, service, price, time, paymentMethod }) {
    ...
    // Formatear la hora utilizando dayjs
